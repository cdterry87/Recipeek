    ...
    <div class="w-full grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-8">
        ...
        <div class="w-full">
            <form
                ...
                wire:submit.prevent="updateRecipe"
            >
                @if (session('update-recipe-message'))
                    <x-alert
                        success
                        class="mb-2"
                    >
                        {{ session('update-recipe-message') }}
                    </x-alert>
                @endif
                ...
                <div class="flex items-center gap-4">
                    @if ($image && $image->temporaryUrl())
                        <div class="flex items-center justify-center flex-col gap-2">
                            ...
                            >
                            <div class="text-xs font-semibold italic">New Recipe Image</div>
                        </div>
                    @endif
