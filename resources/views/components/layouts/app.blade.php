...
>
    <div class="drawer">
        ...
        <div class="drawer-content">
            <header class="py-2 px-6 md:px-16">
                <nav class="navbar bg-base-100">
                    <div class="flex-1">
                        <a
                            href="{{ route('home') }}"
                            class="text-4xl md:text-5xl font-bold text-black hover:text-rose-600 transition duration-300 ease-in-out font-[Arizonia]"
                        >
                            Recipeek
                        </a>
                    </div>
                    ...
                    <div class="hidden md:flex items-center gap-6">
                        <a
                            ...
                            class="text-black font-bold hover:text-rose-600 transition ease-in-out duration-300"
                        >
                            Discover
                        </a>
                        @if (auth()->check())
                            <div class="dropdown dropdown-end">
                                ...
                                <ul
                                    tabindex="0"
                                    class="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 text-lg font-bold shadow"
                                >
                                    <li>
                                        <a
        ...
        <div class="drawer-side z-40">
            ...
            ></label>
            <ul class="menu bg-base-200 text-base-content min-h-full w-80 p-4 flex flex-col gap-2">
                <li>
                    <a
                        href="{{ route('home') }}"
